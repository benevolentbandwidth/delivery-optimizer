        ...
        <div style={{
          ...
          >
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
              <path d="M18 24V12M18 12L13 17M18 12L23 17" stroke="#555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 26h20" stroke="#ccc" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {uploads.map(f => (
                  <div key={f.id} style={{
                    ...
                    <div>
                      <p style={{ fontSize: '13px', fontWeight: 500, color: '#222', marginBottom: '2px' }}>{f.name}</p>
                      <p style={{ fontSize: '12px', color: '#999' }}>{f.size}</p>
                    </div>
                    <button
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M3 5h10M6 5V3h4v2M7 8v4M9 8v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          ...
          <button
            ...
            onMouseLeave={e => (e.currentTarget.style.borderColor = '#d4d2d0')}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M2 12.5h12M2 8.5h8M2 4.5h12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
