...
export const AutocompleteDropdown: React.FC<AutocompleteDropdownProps> = ({
  ...
  return (
    <div
      ...
      className="absolute z-50 w-full mt-1 bg-white border-2 border-blue-300 rounded-md shadow-xl overflow-hidden"
    >
      ...
      <div className="overflow-y-auto" style={{ maxHeight: "84px" }}>
        {suggestions.map((suggestion, idx) => (
          <div
            ...
            className={`px-3 py-2 cursor-pointer border-b border-gray-100 last:border-b-0 text-sm leading-tight ${
              idx === selectedIndex
