        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#888", lineHeight: 1.5 }}>
                Create and manage delivery routes for your team.
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#888", lineHeight: 1.5 }}>
                Upload your assigned route and start your deliveries.
              </p>
            </div>
          </button>
        </div>
